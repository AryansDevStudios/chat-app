  ...
  return (
    <div className="flex flex-col h-full w-full bg-black text-white relative">
      ...
      <ScrollArea ref={scrollRef} className="flex-1">
        <div className="flex flex-col max-w-3xl mx-auto px-4 py-8 min-h-full">
          ...
          <div className="flex flex-col items-center py-12 gap-4">
            ...
            <div className="text-center">
              ...
              <Button variant="secondary" size="sm" className="mt-4 rounded-lg bg-[#262626] hover:bg-[#363636] font-bold px-6">
                View Profile
              </Button>
            </div>
          </div>
            ...
            {messages?.map((msg, index) => {
              ...
              return (
                <div 
                  key={msg.id} 
                  className={cn(
                    "flex flex-col max-w-[85%] lg:max-w-[70%] animate-message", 
      ...
      <footer className="p-4 bg-black sticky bottom-0 z-20">
        <form 
          ...
          className="max-w-3xl mx-auto ig-input-pill shadow-2xl ring-1 ring-white/5"
        >
          <div className="flex items-center gap-1">
             <Button type="button" variant="ghost" size="icon" className="h-8 w-8 -ml-1 rounded-full bg-blue-500 hover:bg-blue-600 transition-all active:scale-90">
          ...
          {inputText.trim() ? (
            <Button 
              type="submit" 
              variant="ghost" 
              className="text-[#0095f6] font-bold text-[15px] p-0 px-4 hover:bg-transparent hover:text-blue-400 active:scale-95 transition-all"
            >
              Send
            </Button>
          ) : (
